...
const normaliseTitle = (title?: string) => (title ? title.replace(/\s*[\u2013\u2014]\s*/, ": ") : "Step 5: Manage Residual Privacy Risks")
...
export default function Step5Page() {
  ...
  const exportJSON = () => {
    ...
    link.href = url
    link.download = "step5-residual-privacy-risks.json"
    link.click()
  ...
  const curatedResources = [
    ...
    { href: "/resources/appendix11", label: "Data Use Agreements (Appendix 11)" },
  ]
    ...
    <div className="space-y-6 text-sm">
      ...
      <div>
        ...
        <ul className="list-disc list-inside space-y-1 text-muted-foreground">
          <li>Completed Step 4 (risk assessment)</li>
          <li>Understanding of Five Safes framework</li>
          <li>Access control mechanisms in place</li>
        </ul>
      </div>
      <div>
      ...
      <div className="rounded-lg border border-amber-500/40 bg-amber-500/10 p-4 text-sm text-muted-foreground">
        <div className="mb-2 flex items-center gap-2 text-amber-500">
          ...
          <span className="font-semibold">Five Safes compliance</span>
        </div>
  ...
  const checklistContent = (
    <div className="space-y-6">
      <section className="space-y-4 rounded-xl border border-border/60 bg-card/70 p-6 shadow-md">
        <header>
          <h2 className="text-xl font-semibold text-foreground">Residual Risk Management</h2>
          <p className="text-sm text-muted-foreground">Ensure all remaining risks are managed through governance and controls.</p>
        </header>
      ...
      {showCompleteModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4">
          <div className="w-full max-w-md space-y-6 rounded-xl border border-border/60 bg-background p-6 shadow-2xl">
            <h3 className="text-xl font-semibold text-foreground">Complete Step 5?</h3>
            <p className="text-sm text-muted-foreground">
              You have completed all required tasks for Step 5. All Five Safes controls are in place.
            </p>
